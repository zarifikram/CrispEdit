...
- **SnapEdit**
  ```shell
  python run_snap.py --model llama3-8b --data_type wiki --cache_sample_num 100 --energy_threshold 0.8 --batch_size 32 --wandb_project JIGSAW
  ```
...
- **SnapEdit Sequential**
  ```shell
  python run_snap.py --model llama3-8b --data_type zsre --cache_sample_num 100 --energy_threshold 0.8 --batch_size 32 --wandb_project JIGSAW --sequential_edit --num_edits 100
  ```
